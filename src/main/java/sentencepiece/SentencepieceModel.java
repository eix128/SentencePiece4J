...
public final class SentencepieceModel extends com.google.protobuf.GeneratedFile {
  ...
  private static final long serialVersionUID = 0L;
    ...
    private TrainerSpec(com.google.protobuf.GeneratedMessage.ExtendableBuilder<sentencepiece.SentencepieceModel.TrainerSpec, ?> builder) {
      super(builder);
    }
    private TrainerSpec() {
      input_ =
    ...
    public static final class Builder extends
      ...
      public <Type> Builder setExtension(
          com.google.protobuf.GeneratedMessage.GeneratedExtension<
              sentencepiece.SentencepieceModel.TrainerSpec, java.util.List<Type>> extension,
  ...
  private static final long serialVersionUID = 0L;
    ...
    private NormalizerSpec(com.google.protobuf.GeneratedMessage.ExtendableBuilder<sentencepiece.SentencepieceModel.NormalizerSpec, ?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      public <Type> Builder setExtension(
          com.google.protobuf.GeneratedMessage.GeneratedExtension<
              sentencepiece.SentencepieceModel.NormalizerSpec, java.util.List<Type>> extension,
          int index, Type value) {
        return super.setExtension(extension, index, value);
      }
      public <Type> Builder addExtension(
  ...
  public interface SelfTestDataOrBuilder extends
     ...
     */
    java.util.List<sentencepiece.SentencepieceModel.SelfTestData.Sample> 
        getSamplesList();
    /**
     * <code>repeated .sentencepiece.SelfTestData.Sample samples = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    private SelfTestData(com.google.protobuf.GeneratedMessage.ExtendableBuilder<sentencepiece.SentencepieceModel.SelfTestData, ?> builder) {
      super(builder);
    }
    ...
    @SuppressWarnings("serial")
    private java.util.List<sentencepiece.SentencepieceModel.SelfTestData.Sample> samples_;
    /**
     * <code>repeated .sentencepiece.SelfTestData.Sample samples = 1;</code>
     */
    @java.lang.Override
    public java.util.List<sentencepiece.SentencepieceModel.SelfTestData.Sample> getSamplesList() {
      return samples_;
    }
    /**
     * <code>repeated .sentencepiece.SelfTestData.Sample samples = 1;</code>
    ...
    public static final class Builder extends
      ...
      public <Type> Builder setExtension(
          com.google.protobuf.GeneratedMessage.GeneratedExtension<
              sentencepiece.SentencepieceModel.SelfTestData, java.util.List<Type>> extension,
          int index, Type value) {
        return super.setExtension(extension, index, value);
      }
      public <Type> Builder addExtension(
      ...
      private void ensureSamplesIsMutable() {
        if ((bitField0_ & 0x00000001) == 0) {
          samples_ = new java.util.ArrayList<sentencepiece.SentencepieceModel.SelfTestData.Sample>(samples_);
          bitField0_ |= 0x00000001;
         }
      }
       ...
       * <code>repeated .sentencepiece.SelfTestData.Sample samples = 1;</code>
       */
      public java.util.List<sentencepiece.SentencepieceModel.SelfTestData.Sample.Builder> 
  ...
  public interface ModelProtoOrBuilder extends
     ...
     */
    java.util.List<sentencepiece.SentencepieceModel.ModelProto.SentencePiece> 
        getPiecesList();
    /**
     * <pre>
     * Sentence pieces with scores.
  ...
  private static final long serialVersionUID = 0L;
    ...
    private ModelProto(com.google.protobuf.GeneratedMessage.ExtendableBuilder<sentencepiece.SentencepieceModel.ModelProto, ?> builder) {
      super(builder);
    }
    private ModelProto() {
    ...
    private static final long serialVersionUID = 0L;
      ...
      private SentencePiece(com.google.protobuf.GeneratedMessage.ExtendableBuilder<sentencepiece.SentencepieceModel.ModelProto.SentencePiece, ?> builder) {
        super(builder);
      }
      ...
      public static final class Builder extends
        ...
        public <Type> Builder setExtension(
            com.google.protobuf.GeneratedMessage.GeneratedExtension<
                sentencepiece.SentencepieceModel.ModelProto.SentencePiece, java.util.List<Type>> extension,
            int index, Type value) {
          return super.setExtension(extension, index, value);
        }
        public <Type> Builder addExtension(
    ...
    @SuppressWarnings("serial")
    private java.util.List<sentencepiece.SentencepieceModel.ModelProto.SentencePiece> pieces_;
    /**
     * <pre>
     * Sentence pieces with scores.
     * </pre>
     ...
     */
    @java.lang.Override
    public java.util.List<sentencepiece.SentencepieceModel.ModelProto.SentencePiece> getPiecesList() {
      return pieces_;
    }
    /**
     * <pre>
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          internalGetTrainerSpecFieldBuilder();
          internalGetNormalizerSpecFieldBuilder();
          internalGetSelfTestDataFieldBuilder();
          internalGetDenormalizerSpecFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
      ...
      public <Type> Builder setExtension(
          com.google.protobuf.GeneratedMessage.GeneratedExtension<
              sentencepiece.SentencepieceModel.ModelProto, java.util.List<Type>> extension,
          int index, Type value) {
        return super.setExtension(extension, index, value);
      }
      public <Type> Builder addExtension(
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                input.readMessage(
                    internalGetTrainerSpecFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000002;
                break;
              } // case 18
              case 26: {
                input.readMessage(
                    internalGetNormalizerSpecFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000004;
                break;
              } // case 26
              case 34: {
                input.readMessage(
                    internalGetSelfTestDataFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000008;
                break;
              } // case 34
              case 42: {
                input.readMessage(
                    internalGetDenormalizerSpecFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000010;
                break;
              } // case 42
      ...
      private void ensurePiecesIsMutable() {
        if ((bitField0_ & 0x00000001) == 0) {
          pieces_ = new java.util.ArrayList<sentencepiece.SentencepieceModel.ModelProto.SentencePiece>(pieces_);
          bitField0_ |= 0x00000001;
         }
      }
       ...
       * <code>repeated .sentencepiece.ModelProto.SentencePiece pieces = 1;</code>
       */
      public java.util.List<sentencepiece.SentencepieceModel.ModelProto.SentencePiece.Builder> 
      ...
      public sentencepiece.SentencepieceModel.TrainerSpec.Builder getTrainerSpecBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
        return internalGetTrainerSpecFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * Spec used to generate this model file.
      ...
      public sentencepiece.SentencepieceModel.NormalizerSpec.Builder getNormalizerSpecBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
        return internalGetNormalizerSpecFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * Spec for text normalization.
      ...
      public sentencepiece.SentencepieceModel.SelfTestData.Builder getSelfTestDataBuilder() {
        bitField0_ |= 0x00000008;
        onChanged();
        return internalGetSelfTestDataFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * Stores sample input and its expected segmentation to verify the model.
      ...
      public sentencepiece.SentencepieceModel.NormalizerSpec.Builder getDenormalizerSpecBuilder() {
        bitField0_ |= 0x00000010;
        onChanged();
        return internalGetDenormalizerSpecFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * Spec for text de-normalization.
